...
void DrawingEff(const char* ,const char* , int, Double_t *,Double_t *, Double_t *,Double_t *, Double_t *, const char*);
void DrawingCls(const char* ,const char* , int, Double_t *,Double_t *, Double_t *,Double_t *, Double_t *, const char*);
...
std::vector< std::pair<std::string,std::string> > dictionary(const char* subd){
 ...
 void DrawingEff(const char* subdetect,const char* chamber, int points, Double_t *hv,Double_t *hverr, Double_t *eff,Double_t *efferr,Double_t *fitparamEff, 
                 const char* id){
 ...
 hveff->SetTitle(("Efficiency vs HV_Eff " + chamber_).c_str());
 ...
 void DrawingCls(const char* subdetect,const char* chamber, int points, Double_t *hv,Double_t *hverr, Double_t *cls, Double_t *clserr, Double_t* fitparamCls,                  const char* id){
 gROOT->Reset();
 if (points ==0.) {std::cout << "N O  D A T A "; return;} 
 std::string chamber_ = chamber;
 std::string id_ = id;
...
void pngProducer(const char* subdetect){
